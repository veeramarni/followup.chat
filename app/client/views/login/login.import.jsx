import { Link, UI, Mixins } from '{followupchat:app-deps}/packages/touchstonejs';
import Container from '{followupchat:app-deps}/packages/react-container';
import NotifyPopup from '/client/components/ui/NotifyPopup';
...
export default React.createClass({
    ...
    statics: {
        ...
        getNavigation (props, app){
            return {
                leftLabel: 'Cancel',
                leftAction: () => {app.transitionTo('onboard:on-boarding', {transition: 'reveal-from-bottom'})},
